...
CREATE TABLE `priorities` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_rails_b0bb8c2a6e` (`retired_by`),
  KEY `fk_rails_555d2a3bd5` (`creator`),
  CONSTRAINT `fk_rails_555d2a3bd5` FOREIGN KEY (`creator`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_rails_b0bb8c2a6e` FOREIGN KEY (`retired_by`) REFERENCES `users` (`id`)
